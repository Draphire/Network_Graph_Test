...
from realnetwork.analyzer import degree_analyzer as da
from realnetwork.analyzer import clustering as ca
from realnetwork.analyzer import degree_correlation as dc
import networkx as nx
from realnetwork.real_network import _load_graph_csv_from_file_system
...
class Graph:
    ...
    def read(self):
        ...
        with open(path.CSV_NETWORK_DIR_PATH+"\\" + self.graph_name + ".txt", "r") as input_graph:
