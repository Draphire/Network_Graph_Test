...
from randomnetwork import random_network_analyzer
...
from realnetwork.distance_analyzer import get_distance_distribution, calculate_distance_prob_distribution, \
    plot_and_store_distance_prob_distribution
...
def _compute_random_network_properties(network_name, n, p):
    ...
    print('expected_clustering_coefficient ' + str(expected_clustering_coefficient))
...
if __name__ == "__main__":
    ...
    _compute_random_network_properties("random",500,0.2)
